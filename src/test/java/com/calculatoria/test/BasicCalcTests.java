...
public class BasicCalcTests extends BaseTest {
    ...
    public void testAdd(String a, String b, String sum) {
        baseCalcSteps.enter2numbers1operation(a, b, "+");
    ...
    public void testSubtract(String a, String b, String sub) {
        baseCalcSteps.enter2numbers1operation(a, b, "-");
        baseCalcSteps.pressEnter();
    ...
    public void testMultiply(String a, String b, String mult) {
        baseCalcSteps.enter2numbers1operation(a, b, "*");
        baseCalcSteps.pressEnter();
    ...
    public void testDivision(String a, String b, String div) {
        baseCalcSteps.enter2numbers1operation(a, b, "/");
        baseCalcSteps.pressEnter();
